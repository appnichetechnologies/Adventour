...
export default function DestinationFetch()
{
                                        ...
                                        <div className="flex flex-col items-center gap-3">
                                            {
                                                items.Image.map((img)=>(
                                                    <img
                                                        src={img.url}
                                                        alt={items.Name}
                                                        className="inline-block relative object-center w-[10dvw] rounded-lg border border-blue-gray-50 bg-blue-gray-50/50 object-contain p-1"
                                                    />
                                                ))
                                            }
                                        </div>
